...
class MenuController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.admin.menus.form');
    }
    ...
    public function edit(Menu $menu)
    {
        ...
        return view('backend.admin.menus.form',compact('menu'));
    }
    ...
    public function update(UpdateMenuRequest $request, Menu $menu)
    {
        ...
        session()->flash('success', __('admin.success_update'));
        return redirect()->route('app.menus.index');
    }
    ...
    public function destroy(Menu $menu)
    {
        ...
        if ($menu->deletable == true)
        {
            ...
            session()->flash('success', __('admin.sorry_delete'));
        }
