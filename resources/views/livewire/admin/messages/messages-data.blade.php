    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <!--begin::Group actions-->
                @if ($checkedMessage)
                    <button type="button" class="btn btn-danger" wire:click="deleteMessages()">{{__('admin.Delete Selected')}} ({{ count($checkedMessage) }})</button>
                @else
                <!--end::Group actions-->
                <!--begin::Filter-->
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                    ...
                    <div class="d-flex justify-content-end m-5">
                        <a type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-subscription-table-filter="reset" href="{{route('app.messages.index')}}">
                            {{__('admin.Reset')}}
                        </a>
                    </div>
                    <!--end::Actions-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="kt_modal_add_user_arader">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">{{__('admin.Messages.Add Message')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
            ...
            <tbody class="text-gray-600 fw-semibold">
                @foreach ($data as $key=>$message)
                    <!--begin::Table row-->
                    <tr class="{{ $this->isChecked($message->id) }}">
                        <!--begin::Checkbox-->
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input group-checked checkbox-delete" type="checkbox" value="{{$message->id}}" wire:model.change="checkedMessage" onclick="selected({{$key+1}})"/>
                            </div>
                        </td>
                        <!--end::Checkbox-->
                        <!--begin::Role=-->
                        ...
                        <!--end::Role=-->
                        <!--begin::Role=-->
                        <td>{{Str::limit($message->email,20)}}</td>
                        <!--end::Role=-->
                        <!--begin::Joined-->
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" wire:click.prevent="$dispatch('messageShow', { id: {{ $message->id }} })" class="menu-link px-3">{{__('admin.View')}}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" wire:click.prevent="$dispatch('subscriberDelete', { id: {{ $message->id }} })" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{__('admin.Delete')}}</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
