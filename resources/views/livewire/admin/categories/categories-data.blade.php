    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <!--begin::Group actions-->
                @if ($checkedCategory)
                    <button type="button" class="btn btn-danger" wire:click="deleteCategories()">{{__('admin.Delete Selected')}} ({{ count($checkedCategory) }})</button>
                @else
                <!--end::Group actions-->
                <!--begin::Add user-->
                ...
                <!--end::Svg Icon-->{{__('admin.categories.Add Category')}}</button>
                <!--end::Add user-->
                <!--begin::Filter-->
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                    ...
                    <!--end::Separator-->
                    <!--begin::Content-->
                    <div class="px-7" data-kt-user-table-filter="form">
                        <!--begin::Input group-->
                        <div class="mb-10">
                    ...
                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="form-label fs-6 fw-semibold">{{__('admin.Main Category')}}:</label>
                            <select wire:model.change="main_category_id" class="form-select form-select-solid fw-bold" data-placeholder="{{__('admin.Select an option')}}" data-allow-clear="true" >
                    ...
                    <div class="d-flex justify-content-end m-5">
                        <a type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-subscription-table-filter="reset" href="{{route('app.categories.index')}}">
                            {{__('admin.Reset')}}
                        </a>
                    </div>
                    <!--end::Actions-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="kt_modal_add_user_arader">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">{{__('admin.categories.Add Category')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <!--end::Modal header-->
                        @livewire('admin.categories.categories-create', ['data'=>$data], key(Str::random(10)))
                    </div>
                    <!--end::Modal content-->
                </div>
                <!--end::Modal dialog-->
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-100px" id="th">
                        {{__('admin.banners.Picture')}}
                    </th>
                    <th wire:click="sort('parent_id')" class="min-w-100px" id="th">
                        <i class="bi bi-arrow-down-up"></i>
                        {{__('admin.Main Category')}}
                    </th>
                    <th wire:click="sort('name')" class="min-w-100px" id="th">
                        <i class="bi bi-arrow-down-up"></i>
                        {{__('admin.Name')}}
                    </th>
                    <th wire:click="sort('description')" class="min-w-100px" id="th">
                        <i class="bi bi-arrow-down-up"></i>
                        {{__('admin.Slug')}}
                    </th>
                    <th wire:click="sort('created_at')" class="min-w-100px" id="th">
                        <i class="bi bi-arrow-down-up"></i>
                        {{__('admin.Created At')}}
                    </th>
                    ...
                    <th class="min-w-100px" id="th"></th>
                    <th class="min-w-50px" id="th"></th>
                </tr>
                <!--end::Table row-->
            </thead>
            <!--end::Table head-->
                    ...
                    <tr class="{{ $this->isChecked($category->id) }}">
                        ...
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input group-checked checkbox-delete" type="checkbox" value="{{$category->id}}" wire:model.change="checkedCategory" onclick="selected({{$key+1}})"/>
                            </div>
                        </td>
                        <!--end::Checkbox-->
                        <!--begin::User=-->
                        <td class="align-items-center">
                            ...
                            <div class="symbol overflow-hidden me-3">
                                <div class="symbol-label">
                                    <img src="{{getImage($category->picture,null,50,50)}}" alt="{{Str::limit($category->name,20)}}" title="{{Str::limit($category->name,20)}}"/>
                                </div>
                            </div>
                            <!--end::Avatar-->
                        </td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" wire:click.prevent="$dispatch('categoryUpdate', { id: {{ $category->id }} })" class="menu-link px-3">{{__('admin.Edit')}}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" wire:click.prevent="$dispatch('categoryDelete', { id: {{ $category->id }} })" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{__('admin.Delete')}}</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
