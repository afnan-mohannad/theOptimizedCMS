    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <!--begin::Group actions-->
                @if ($checkedTag)
                    <button type="button" class="btn btn-danger" wire:click="deleteTags()">{{__('admin.Delete Selected')}} ({{ count($checkedTag) }})</button>
                @else
                <!--end::Group actions-->
                <!--begin::Add user-->
                ...
                <!--end::Svg Icon-->{{__('admin.tags.Add Tag')}}</button>
                <!--end::Add user-->
                <!--begin::Filter-->
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                    ...
                    <div class="d-flex justify-content-end m-5">
                        <a type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-subscription-table-filter="reset" href="{{route('app.tags.index')}}">
                            {{__('admin.Reset')}}
                        </a>
                    </div>
                    <!--end::Actions-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="kt_modal_add_user_arader">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">{{__('admin.tags.Add Tag')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <!--end::Modal header-->
                        @livewire('admin.tags.tags-create', ['data'=>$data], key(Str::random(10)))
                    </div>
                    <!--end::Modal content-->
                </div>
                <!--end::Modal dialog-->
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
            ...
            <tbody class="text-gray-600 fw-semibold">
                @foreach ($data as $key=>$tag)
                    <!--begin::Table row-->
                    <tr class="{{ $this->isChecked($tag->id) }}">
                        <!--begin::Checkbox-->
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input group-checked checkbox-delete" type="checkbox" value="{{$tag->id}}" wire:model.change="checkedTag" onclick="selected({{$key+1}})" />
                            </div>
                        </td>
                        <!--end::Checkbox-->
                        <!--begin::Role=-->
                        <td>{{Str::limit($tag->slug,20)}}</td>
                        <!--end::Role=-->
                        <!--begin::Joined-->
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" wire:click.prevent="$dispatch('tagUpdate', { id: {{ $tag->id }} })" class="menu-link px-3">{{__('admin.Edit')}}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" wire:click.prevent="$dispatch('tagDelete', { id: {{ $tag->id }} })" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{__('admin.Delete')}}</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
