            ...
            <div class="container-xxl">
                    ...
                    <div class="card-header pt-10">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <h2 class="m-5">{{ __('admin.Edit') }} {{__('admin.Role')}}</h2>
                            </div>
                            <!--end::Title-->
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="main-card mb-3 card">
                        <!-- form start -->
                        <form id="roleFrom" role="form" wire:submit.prevent='submit'>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" wire:model='name' id="name" class="form-control mb-2 @error('name') is-invalid @enderror" placeholder="{{__('admin.Name')}}" autofocus/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="p-2">
                                        @include('livewire.admin.error', ['property' => 'permissions'])
                                    </p>
                                </div>
                                                        ...
                                                        <div class="mb-3 ml-4">
                                                            <div class="custom-control custom-checkbox mb-2">
                                                                ...
                                                                <label class="custom-control-label"
                                                                    for="permission-{{ $permission->id }}">{{ $permission->name[lang()] }}{{--$permission->id--}}</label>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
