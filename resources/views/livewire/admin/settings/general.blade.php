        ...
        <div class="container-xxl">
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <!--end::Svg Icon-->
                            <!--begin::Title-->
                            <div class="d-flex flex-row" style="gap:798px">
                        ...
                        <div class="panel my-3 d-flex">
                            ...
                            <button type="button" class="btn btn-primary bg-color mx-2" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                                ...
                                <!--end::Svg Icon-->{{ __(' Add New Setting') }}
                            </button>
                            <!--end::Add user-->
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_user_arader">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bold">{{__('Add New Setting')}}</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                ...
                                <!--end::Modal header-->
                                @livewire('admin.settings.setting-create')
                            </div>
                            <!--end::Modal content-->
                        </div>
                        <!--end::Modal dialog-->
                    ...
                    <!--end::Details-->
                    @include('backend.components.settings-sidebar')
                </div>
            </div>
            <!--end::Navbar-->
            <!--begin::Basic info-->
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="collapse show">
                    ...
                    @livewire('admin.settings.general-update')
                </div>
                <!--end::Content-->
            </div>
            <!--end::Basic info-->
...
@endsection
@push('js')
<script src="{{config('customConfig.cdn_assets_url')}}/backend/js/setting.js" defer></script>
@endpush
