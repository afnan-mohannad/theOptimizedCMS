<x-create-modal title="{{__('admin.banners.Add Banner')}}">
    <!--begin::Input group-->
    <div class="fv-row mb-7">
        <div class="col-12">
            ...
            @if ($picture)
                <div class="my-4">
                    <img src="{{ $picture->temporaryUrl() }}" class="banner-img">
                </div>
            @endif
            @if ($picture)
            <!--begin::delete-->
    ...
    <div class="row mb-7">
        <div class="col-12">
            <!--begin::Label-->
            <label class="required fw-semibold fs-6 mb-2">{{__('admin.banners.heading1_text')}} {{ __('admin.(ar)') }}
                <i class="bi bi-info-circle-fill" data-bs-toggle="tooltip" title="{{__('admin.min_max_msg', ['max'=>100, 'min'=>3])}}"></i>
            </label>
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" wire:model="heading1_text_ar" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{__('admin.banners.heading1_text')}} {{ __('admin.(ar)') }}" />
            <!--end::Input-->
    ...
    <div class="row mb-7">
        <div class="col-12">
            <!--begin::Label-->
            <label class="required fw-semibold fs-6 mb-2">{{__('admin.banners.heading2_text')}} {{ __('admin.(ar)') }}
                <i class="bi bi-info-circle-fill" data-bs-toggle="tooltip" title="{{__('admin.min_max_msg', ['max'=>100, 'min'=>3])}}"></i>
            </label>
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" wire:model="heading2_text_ar" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{__('admin.banners.heading2_text')}} {{ __('admin.(ar)') }}" />
            <!--end::Input-->
    ...
    <div class="row mb-7">
        <div class="col-12">
            <!--begin::Label-->
            <label class="required fw-semibold fs-6 mb-2">{{__('admin.banners.button_text')}} {{ __('admin.(ar)') }}
                <i class="bi bi-info-circle-fill" data-bs-toggle="tooltip" title="{{__('admin.min_max_msg', ['max'=>50, 'min'=>3])}}"></i>
            </label>
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" wire:model="button_text_ar" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{__('admin.banners.button_text')}} {{ __('admin.(ar)') }}" />
            <!--end::Input-->
    ...
    <div class="row mb-7">
        <div class="col-12">
            <!--begin::Label-->
            <label class="fw-semibold fs-6 mb-2">{{__('admin.button_href')}}
            </label>
            <!--end::Label-->
            <!--begin::Input-->
