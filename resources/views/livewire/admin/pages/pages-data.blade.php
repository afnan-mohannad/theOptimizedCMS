...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <!--begin::Post-->
    <div class="page d-flex flex-column-fluid" id="kt_page">
        <!--begin::Container-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                            <!--begin::Group actions-->
                            @if ($checkedPage)
                                <button type="button" class="btn btn-danger me-3" wire:click="deletePages()">{{__('admin.Delete Selected')}} ({{ count($checkedPage) }})</button>
                            @else
                            <!--end::Group actions-->
                            <a href="{{route('app.pages.create')}}" class="btn btn-primary bg-color me-lg-5">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-subscription-table-filter="form">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-subscription-table-filter="reset" href="{{route('app.pages.index')}}">
                                            {{__('admin.Reset')}}
                                        </a>
                                    </div>
                                    <!--end::Actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th wire:click="sort('slug')" class="min-w-100px" id="th">
                                        {{__('admin.Slug')}}
                                        <i class="bi bi-arrow-down-up"></i>
                                    </th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr class="{{ $this->isChecked($page->id) }}">
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input class="form-check-input group-checked checkbox-delete" type="checkbox" value="{{$page->id}}" wire:model.change="checkedPage" onclick="selected({{$key+1}})"/>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('app.pages.update', $page->id)}}" class="menu-link px-3">{{__('admin.Edit')}}</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{route('app.pages.show', $page->id)}}" class="menu-link px-3">{{__('admin.View')}}</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" wire:click.prevent="$dispatch('pageDelete', { id: {{ $page->id }} })" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{__('admin.Delete')}}</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
